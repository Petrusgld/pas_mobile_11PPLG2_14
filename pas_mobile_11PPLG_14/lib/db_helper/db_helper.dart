...
class DbHelper {
  ...
  // Add data
  Future<int> insertBookmark(ProductModel product) async {
    final client = await db;
    return client.insert(
      'bookmarked',
      {'id': product.id, 'isBookmarked': product.isBookmarked ? 1 : 0},
  ...
  Future<List<ProductModel>> getList() async {
    ...
    return productModelFromJson(jsonEncode(data)).toList();
  }
